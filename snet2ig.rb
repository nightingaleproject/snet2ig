...
post '/' do
  ...
  Dir.glob(File.join('ig', 'pages', '**', '*.*ml')).each do |f|
    ...
    footerstamp2 = "Links: <a style=\"color: #81BEF7\" href=\"#{params[:tocurl]}\">Table of Contents</a> | <a style=\"color: #81BEF7\" href=\"qa.html\">QA Report</a> | <a style=\"color: #81BEF7\" href=\"#{params[:historyurl]}\">Version History</a> | <a style=\"color: #81BEF7\" rel=\"license\" href=\"http://build.fhir.org/license.html\"><img style=\"border-style: none;\" alt=\"CC0\" src=\"cc0.png\"/></a> | <a style=\"color: #81BEF7\" href=\"https://gforge.hl7.org/gf/project/fhir/tracker/\" target=\"_blank\">Propose a change</a>"
